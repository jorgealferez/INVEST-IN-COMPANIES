...
<div class="container  pt-0 pb-5">
	...
	<div class="row pb-5">
		...
		<div class="col-lg-4 text-center equal">
			...
			<p class="p-3 text-justify ">Muchas empresas españolas son fruto del gran crecimiento del país después de la crisis de los años 70. Sus propietarios
				están en edad de jubilación y muchos no tienen sucesión, con lo que su única alternativa es la venta de la sociedad a
		...
		<div class="col-lg-4  text-center equal">
			...
			<p class="p-3 text-justify">El término de unicornio se aplica a las empresas que consiguen un valor superior a 1.000 millones de dólares en su etapa
		...
		<div class="col-lg-4  text-center equal">
			...
			<h3 class="pt-5 pb-2 text-center">Las empresas no pueden ser una oficina de empleo para los propietarios</h3>
			<p class="p-3 text-justify">En sus manos, como CEO de Vidal Golosinas -consejero delegado-, está seguir liderando un legado empresarial de más de
				medio siglo. Francisco José Hernández Arnaldos, 53 años, padre de tres hijos, desempeña también el puesto de vicepresidente
				con el reto de seguir haciendo crecer a una empresa que es todo un referente en Molina de Segura y en la Región.</p>
		</div>
	</div>
	<!-- /.col-lg-4 -->
</div>

...
<div class="container my-5">
    ...
    <div class="row   text-justify">
        ...
        <div class="col-md-7">
            <ul class="lista">
                <li>
                    <i class="fas fa-check"></i>¿Se aproxima la edad de jubilación y no cuentas con herederos que quieran <strong>continuar con la actividad</strong> de la empresa?
                </li>
                <li>
                ...
                <li>
                    <i class="fas fa-check"></i>¿La <strong>obsolescencia tecnológica</strong> te obliga a realizar inversiones que no puedes afrontar?
                </li>
            </ul>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <p>Con la Plataforma Invest in Companies, lograrás sortear los problemas que encontrarías por el camino de la venta,
                si lo recorrieses solo, y estarías acompañado y asesorado en todo momento por grandes profesionales y especialistas
                en el sector.</p>

            <a class="btn-invest  bg-transparent text-uppercase fa-1x " href="#formulario">{{ __('Aplicar') }}</a>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group {{ $errors->has('name') ? ' has-danger' : '' }}">
                            <label for="name">{{ __('Nombre y apellidos') }}</label>
                            <input type="text " value="{{ ((old( 'name')) ? old( 'name') : $request->name ) }}" class="form-control form-control-line
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group {{ $errors->has('email') ? ' has-danger' : '' }}">
                            <label for="email">{{ __('Email de contacto') }}</label>
                            <input type="email " name="email" id="email" class="form-control form-control-line {{ $errors->has('email') ? ' form-control-danger' : '' }}">{{ ((old( 'email')) ? old( 'email') : $request->email ) }}
                            @if ($errors->has('email'))
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group {{ $errors->has('phone') ? ' has-danger' : '' }}">
                            <label for="phone">{{ __('Teléfono de contacto') }}</label>
                            <input type="text " name="phone" id="phone" class="form-control form-control-line {{ $errors->has('phone') ? ' form-control-danger' : '' }}" maxlength="9">{{ ((old( 'phone')) ? old( 'phone') : $request->phone ) }}
                            @if ($errors->has('phone'))
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <button class="btn btn-verde waves-effect waves-light">{{ __('Enviar') }}</button>

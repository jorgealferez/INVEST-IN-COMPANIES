            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex no-block">
                        <div>
                            <h4 class="card-title"><span class="lstick"></span><i class="mdi mdi-account-multiple-plus"></i> {{ __('Crear nueva
                                usuario') }}</h4>
                        </div>
                    </div>
                    <form class="form-control-line form-material" action="{{ action('Dashboard\UsuariosController@store')}}">
                        ...
                        <div class="form-group {{ $errors->has('surname') ? ' has-danger' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input type="text" value="{{ old('surname') }}" class="form-control form-control-line {{ $errors->has('surname') ? ' form-control-danger' : '' }}"
                        ...
                        <div class="form-group {{ $errors->has('role') ? ' has-danger' : '' }}">
                            ...
                            <div class="col-md-12">
                                <select name="role" id="role" class="form-control form-control-line {{ $errors->has('role') ? ' form-control-danger' : '' }}"
                                    required>

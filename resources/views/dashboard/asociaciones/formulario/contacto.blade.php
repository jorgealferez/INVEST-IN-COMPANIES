    ...
    <div class="col-md-12">
        ...
        <div class="form-group {{ $errors->has('contact') ? ' has-danger' : '' }}">
            ...
            <div class="input-group">
                ...
                <input type="text" value="{{ ((old( 'contact')) ? old( 'contact') : $asociacion->contact ) }}" class="form-control form-control-line {{ $errors->has('contact') ? ' form-control-danger' : '' }}" id="contact" name="contact" required>
            </div>
    ...
    <div class="col-md-12">
        ...
        <div class="form-group {{ $errors->has('contactSurname') ? ' has-danger' : '' }}">
            ...
            <div class="input-group">
                ...
                <input type="text" value="{{ ((old( 'contactSurname')) ? old( 'contactSurname') : $asociacion->contactSurname ) }}" class="form-control form-control-line {{ $errors->has('contactSurname') ? ' form-control-danger' : '' }}" id="contactSurname" name="contactSurname" required>
    ...
    <div class="col-md-12">
        ...
        <div class="form-group {{ $errors->has('contactEmail') ? ' has-danger' : '' }}">
            ...
            <div class="input-group">
                ...
                <input type="text" value="{{ ((old( 'contactEmail')) ? old( 'contactEmail') : $asociacion->contactEmail ) }}" class="form-control form-control-line {{ $errors->has('contactEmail') ? ' form-control-danger' : '' }}" id="contactEmail" name="contactEmail">
            </div>
    ...
    <div class="col-md-12">
        ...
        <div class="form-group {{ $errors->has('contactPhone') ? ' has-danger' : '' }}">
            ...
            <div class="input-group">
                ...
                <input type="text" value="{{ ((old( 'contactPhone')) ? old( 'contactPhone') : $asociacion->contactPhone ) }}" class="form-control form-control-line

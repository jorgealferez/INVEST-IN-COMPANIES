            ...
            <div class="card"> <img class="card-img" src="{{ asset('/images/background/socialbg.jpg') }}" alt="Card image">
                ...
                <div class="card-img-overlay card-inverse social-profile d-flex ">
                    ...
                    <div class="align-self-center">
                        <img src="{{ asset('/images/users/1.jpg') }}" class="img-circle" width="100">
                                    ...
                                    <div class="message-box contact-box">
                                        ...
                                        <div class="message-widget contact-widget">
                                            ...
                                            <div class="card m-b-0">
                                                <a href="#collapse{{ $usuario_asociacion->id }}" class="card-header text-decoration-none" id="heading11" role="button" aria-expanded="false" aria-controls="collapse{{ $usuario_asociacion->id }}" data-toggle="collapse" data-target="#collapse{{ $usuario_asociacion->id }}">

                                                    <div class="user-img">
                                                        <h6>
                                                            <span class="round {{ $usuario_asociacion->getRoleClass() }}">{{ substr($usuario_asociacion->roles->first()->name,0,1) }}</span>
                                                    ...
                                                    <div class="mail-contnet">
                                                        <h5>
                                                            {{ e( $usuario_asociacion->name.' '. $usuario_asociacion->surname) }}
                                                        </h5>
...
<link href="{{ asset('css/dashboard/select2.min.css') }}" rel="stylesheet" type="text/css" />

<script src="{{ asset('js/dashboard/select2.full.min.js') }}" type="text/javascript"></script>

                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive ">
                        <table class="table  table-hover table-boder  tabla-inversores">
                            <tbody>
                                @if($inversiones->total()>0)
                                @foreach ($inversiones->sortByDesc('created_at') as $inversion)

                                <tr>
                                    <td class="p-0">
                                        <a href="#collapse{{ $inversion->oferta->id }}" class="tab-usuarios-link" role="button" aria-expanded="false" aria-controls="collapse{{ $inversion->oferta->id }}" data-toggle="collapse">
                                            ...
                                            <div class="card card-profile">
                                                ...
                                                <div class="card-body   bg-gray">
                                                    <h4 class="card-title text-white m-0">
                                                        ...
                                                        @if (!$inversion->oferta->active)
                                                        <span class="badge badge-danger float-right ml-2"> {{ __('Eliminada') }}</span>
                                                        @endif
                                                ...
                                                <div class="card-body ">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <h6>{{ e($inversion->oferta->address) }}, {{ e($inversion->oferta->poblacion->name) }} ({{ e($inversion->oferta->provincia->name) }})</h6>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <a href="{{ e($inversion->oferta->web) }}" class="link text-muted" target="_blank">
                                                                <h6>{{ e($inversion->oferta->web) }}</h6>
                                                            </a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="card-body ">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 ">
                                                            ...
                                                            <h6><i class="ti-user"></i> {{ e($inversion->oferta->contactFullName) }}</h6>
                                                        </div>

                                                        <div class="col-md-4 ">
                                                            <small class="verde">{{ __('Email') }}:</small>
                                                            <a href="mailto:{{ e($inversion->oferta->contactEmail) }}" class="link text-muted" target="_blank">
                                                                <h6><i class="ti-email"></i> {{ e($inversion->oferta->contactEmail) }}</h6>
                                                            </a>
                                                        </div>

                                                        <div class="col-md-4 ">
                                                            <small class="verde">{{ __('Teléfono') }}:</small>
                                                            <h6><i class="ti-mobile"></i> {{ e($inversion->oferta->contactPhone) }}</h6>
                                                        </div>
                                                    </div>
                                                </div>

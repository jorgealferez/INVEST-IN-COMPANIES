            ...
            <select name="asociacion_id" id="asociacion_id" class="form-control form-control-line {{ $errors->has('asociacion_id') ? ' form-control-danger' : '' }}"
                required>
                    ...
                    <option value="{{ $asociacion->id }}"
                        @if ( old('asociacion_id')==$asociacion->id || (!empty($oferta) && $asociacion->id==$oferta->asociacion()->first()->id))
                                selected
                        @endif
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('cif') ? ' has-danger' : '' }}">
            ...
            <input type="text" value="{{ (isset($oferta)) ?  $oferta->cif : (old( 'cif')) }}" class="form-control form-control-line {{ $errors->has('cif') ? ' form-control-danger' : '' }}"
                id="cif" name="cif" required maxlength="9"> @if ($errors->has('cif'))
...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('socios') ? ' has-danger' : '' }}">
            ...
            <input type="text" value="{{ (isset($oferta)) ?  $oferta->socios : (old( 'socios')) }}" class="form-control form-control-line {{ $errors->has('socios') ? ' form-control-danger' : '' }}"
                id="socios" name="socios"> @if ($errors->has('socios'))
    ...
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('empleados') ? ' has-danger' : '' }}">
            ...
            <input type="text" value="{{ (isset($oferta)) ?  $oferta->empleados : (old( 'empleados')) }} " class="form-control form-control-line {{ $errors->has('empleados') ? ' form-control-danger' : '' }}"
                id="empleados" name="empleados"> @if ($errors->has('empleados'))
    ...
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('año') ? ' has-danger' : '' }}">
            ...
            <input type="text" value="{{ (isset($oferta)) ?  $oferta->año : (old( 'año')) }} " class="form-control form-control-line {{ $errors->has('año') ? ' form-control-danger' : '' }}"
                id="año" name="año"> @if ($errors->has('año'))
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="form-group {{ $errors->has('motivo') ? ' has-danger' : '' }}">
            ...
            <textarea name="motivo" id="motivo" class="form-control form-control-line {{ $errors->has('motivo') ? ' form-control-danger' : '' }}"
                rows="5">{{ (isset($oferta)) ?  $oferta->motivo : (old( 'motivo')) }} </textarea> @if ($errors->has('motivo'))
        ...
        <div class="form-group {{ $errors->has('sector_id') ? ' has-danger' : '' }}">
            ...
            <select name="sector_id" id="sector_id" class="form-control form-control-line {{ $errors->has('sector_id') ? ' form-control-danger' : '' }}">
                        ...
                        <option value="{{ $sector->id }}"
                                @if ( old('sector_id')==$sector->id ||  (!empty($oferta) && $oferta->sector_id==$sector->id))
                                selected
            ...
            <select name="valoracion_id" id="valoracion_id" class="form-control form-control-line {{ $errors->has('valoracion_id') ? ' form-control-danger' : '' }}">
                    <option value="">{{ __('Selecciona valoracion') }}</option>
                        ...
                        <option value="{{ $valoracion->id }}"
                            @if ( old('valoracion_id')==$valoracion->id ||  (!empty($oferta) && $oferta->valoracion_id==$valoracion->id))
                                selected
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            <div class="switch">
                <label>
                    <input type="checkbox"
            @if ( old('local') ||  (!empty($oferta) && $oferta->local==1))
                    checked
            @endif
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group {{ $errors->has('address') ? ' has-danger' : '' }}">
            ...
            <input type="text" value="{{ (isset($oferta)) ?  $oferta->address : (old( 'address')) }} " class="form-control form-control-line {{ $errors->has('address') ? ' form-control-danger' : '' }}"
                id="address" name="address"> @if ($errors->has('address'))
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('municipio') ? ' has-danger' : '' }}">
            ...
            <input type="text" value="{{ (isset($oferta)) ?  $oferta->municipio : (old( 'municipio')) }} " class="form-control form-control-line {{ $errors->has('municipio') ? ' form-control-danger' : '' }}"
                id="municipio" name="municipio"> @if ($errors->has('municipio'))
    ...
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('provincia_id') ? ' has-danger' : '' }}">
            ...
            <select name="provincia_id" id="provincia_id" class="form-control form-control-line {{ $errors->has('provincia_id') ? ' form-control-danger' : '' }}">
                            <option value="">{{ __('Selecciona provincia') }}</option>
                            @foreach ($provincias as $provincia)
                            <option value="{{ $provincia->id }}"
                                @if ( old('provincia_id')==$provincia->id ||  (!empty($oferta) && $oferta->provincia_id == $provincia->id ))
                                    selected
    ...
    <div class="col-md-12">
        <div class="form-group {{ $errors->has('web') ? ' has-danger' : '' }}">
            ...
            <div class="input-group">
                ...
                <input type="text" value="{{ (isset($oferta)) ?  $oferta->web : (old( 'web')) }} " class="form-control form-control-line {{ $errors->has('web') ? ' form-control-danger' : '' }}"
                    id="web" name="web">
            </div>
            @if ($errors->has('web'))
...
<div class="row">
    <div class="col-md-4">
        <div class="form-group {{ $errors->has(['explotacion1','explotacion2','explotacion3']) ? ' has-danger' : '' }}">
            ...
            <input type="text" value="{{ (isset($oferta)) ?  $oferta->explotacion1 : (old( 'explotacion1')) }}" class="form-control form-control-line {{ $errors->has('explotacion1') ? ' form-control-danger' : '' }}"
                id="explotacion1" name="explotacion1">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group {{ $errors->has(['explotacion1','explotacion2','explotacion3']) ? ' has-danger' : '' }}">
            <label class="form-control-label" for="explotacion2">{{ __('explotacion2') }}</label>
            <input type="text" value="{{ (isset($oferta)) ?  $oferta->explotacion2 : (old( 'explotacion2')) }}" class="form-control form-control-line {{ $errors->has('explotacion2') ? ' form-control-danger' : '' }}"
                id="explotacion2" name="explotacion2">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group {{ $errors->has(['explotacion1','explotacion2','explotacion3']) ? ' has-danger' : '' }}">
            <label class="form-control-label" for="explotacion3">{{ __('explotacion3') }}</label>
            <input type="text" value="{{ (isset($oferta)) ?  $oferta->explotacion3 : (old( 'explotacion3')) }}" class="form-control form-control-line {{ $errors->has('explotacion3') ? ' form-control-danger' : '' }}"
                id="explotacion3" name="explotacion3">
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('contact') ? ' has-danger' : '' }}">
            ...
            <div class="input-group">
                ...
                <input type="text" value="{{ (isset($oferta)) ?  $oferta->contact : (old( 'contact')) }}" class="form-control form-control-line {{ $errors->has('contact') ? ' form-control-danger' : '' }}"
    ...
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('contactSurname') ? ' has-danger' : '' }}">
            ...
            <div class="input-group">
                ...
                <input type="text" value="{{ (isset($oferta)) ?  $oferta->contactSurname : (old( 'contactSurname')) }}" class="form-control form-control-line {{ $errors->has('contactSurname') ? ' form-control-danger' : '' }}"
                    id="contactSurname" name="contactSurname">
            </div>
    ...
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('contactEmail') ? ' has-danger' : '' }}">
            ...
            <div class="input-group">
                ...
                <input type="text" value="{{ (isset($oferta)) ?  $oferta->contactEmail : (old( 'contactEmail')) }}" class="form-control form-control-line {{ $errors->has('contactEmail') ? ' form-control-danger' : '' }}"

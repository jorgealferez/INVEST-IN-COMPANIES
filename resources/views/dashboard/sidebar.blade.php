    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li>
                    <a href="{{ route('dashboard') }}" data-active="/dashboard"><i class="mdi mdi-poll-box"></i><span class="hide-menu">
                        {{ __('Dashboard') }}
                ...
                <li>
                    ...
                    <li>
                        ...
                        <i class="mdi mdi-chart-line"></i><span class="hide-menu">{{ __('Mis inversiones') }}
                        </span>
                    </a>
                        </li>
                        @endif
